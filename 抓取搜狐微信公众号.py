...
def getcontent(listurl):
    ...
    <body>'''
    fh = open(r"C:\Users\tjajia\Desktop\Python爬虫实战：分析天猫和京东胸罩销售数据源代码\1.html", "wb")
    fh.write(html1.encode("utf-8"))
    fh.close()
    fh = open(r"C:\Users\tjajia\Desktop\Python爬虫实战：分析天猫和京东胸罩销售数据源代码\2.html", "ab")
    ...
    '''
    fh = open(r"C:\Users\tjajia\Desktop\Python爬虫实战：分析天猫和京东胸罩销售数据源代码\1.html", "ab")
